...
%>
		<form action="MyServlet" method="post" name="form1">
			<table	align="center" width="65%" height="100%" border="0">
				<tr >
					<td align="left" colspan="2"><font size="5" style="font-style: inherit">注册ShinyTour</font></td>
				</tr>	
				<tr >
					<td align="left" colspan="2" class="arinfo2">
							欢迎注册ShinyTOur旅行游记，把您的好友带进来更会增加您的兴趣。
					</td>
				</tr>	
				...
				<tr >
					...
					<td><input name="u_state" value="我开通了ShinyTour。" class="f2_input2"/></td>
				</tr>	
				<tr height="10px"></tr>	
				<tr>
